...
/*001*/ "Action","",EXCLSV,0,0,0,{Btwo(0),Btwo(-1),2,3,4,5,6,7,8,0},
...
/*006*/ "Main header","main",LEAF,1,4,0,{Btwo(-1),Btwo(-1),0,1,
        Btwo(1),Btwo(0),Btwo(0),0,0,Btwo(0),Btwo(0),0},
/*007*/ "List all scan numbers","sn",LEAF,1,5,0,{Btwo(-1),Btwo(-1),0,
        1,Btwo(1),Btwo(0),Btwo(0),0,0,Btwo(0),Btwo(0),0},
/*008*/ "Print date and time of stack 1","date",LEAF,1,6,0,{Btwo(-1),
